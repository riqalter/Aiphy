...
async function main() {
  ...
  const proValues = {
    ...
    price: 99000,
    features: [
      "Semua akses modul pembelajaran",
      "Pesan AI Tanpa Batas",
      "Sertifikat kelulusan digital",
      "Eksekusi kode Python sandbox",
    ],
    aiLimit: -1,
  };
  ...
  if (adminUsers.length === 0) {
    ...
    console.log(
      "[Seed] Super admin created: admin@aiphy.ug.ac.id / adminpassword",
    );
  } else {
  ...
  const faqsList = [
    {
      ...
      answer:
        "AIphy adalah platform pembelajaran kecerdasan buatan (AI) adaptif berbasis Generative AI yang dirancang khusus untuk membantu pemula memahami konsep AI dengan bahasa yang sederhana dan interaktif.",
      category: "general",
      order: 1,
    },
    {
      ...
      answer:
        "Ya, Anda bisa menggunakan akun Basic Learner secara gratis. Paket gratis ini mencakup akses modul dasar dan 50 pesan AI per hari dengan asisten virtual kami.",
      category: "general",
      order: 2,
    },
    {
      ...
      answer:
        "Anda dapat masuk ke dashboard, membuka halaman pengaturan atau pricing, lalu menekan tombol beli paket Pro. Pembayaran dapat disimulasikan menggunakan gerbang pembayaran sandbox Xendit.",
      category: "payment",
      order: 1,
    },
    {
      ...
      answer:
        "Pengguna Pro Learner mendapatkan akses ke seluruh modul kurikulum tingkat menengah/lanjut, pesan AI tanpa batas harian, sertifikat kelulusan digital, dan kemampuan eksekusi kode Python langsung di dalam sandbox terisolasi.",
      category: "general",
      order: 3,
    },
  ];
